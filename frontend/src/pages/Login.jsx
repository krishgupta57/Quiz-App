    ...
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="bg-[#0f172a]/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl animate-fade-in w-full max-w-[400px] p-10">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-slate-400">Sign in to continue your quiz</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-slate-400">
          Don't have an account? <Link to="/signup" className="text-indigo-400 font-semibold hover:text-indigo-300 transition-colors ml-1">Sign up</Link>
        </p>
      </div>
    </div>
  );
